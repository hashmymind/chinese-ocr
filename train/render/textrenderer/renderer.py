...
import render.libs.math_utils as math_utils
from render.libs.utils import draw_box, draw_bbox, prob, apply
from render.libs.timer import Timer
from render.textrenderer.liner import Liner
from render.textrenderer.noiser import Noiser
import render.libs.font_utils as font_utils

# noinspection PyMethodMayBeStatic
from render.textrenderer.remaper import Remaper
...
class Renderer(object):
    ...
    def gen_img(self, img_index):
        ...
        while word_size[0] == 0 or word_size[1] == 0:
            word, font, word_size = self.pick_font(img_index)
    ...
    def gen_bg_from_image(self, width, height):
        ...
        while out.shape[0] == 0 or out.shape[1] == 0 or out is None:
            x_offset, y_offset = self.random_xy_offset(height, width, out.shape[0], out.shape[1])
